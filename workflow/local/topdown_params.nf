...
params.prsm_fdr = params.prsm_fdr ?: { log.warn "No prsm cutoff value provided. Will use default 0.0123"; return 0.0123 }()
params.prsm_typ = params.prsm_typ ?: { log.warn "No prsm cutoff type provided. Will use default FDR"; return "FDR" }()
params.prot_fdr = params.prot_fdr ?: { log.warn "No proteoform cutoff value provided. Will use default 0.0123"; return 0.0123 }()
params.prot_typ = params.prot_typ ?: { log.warn "No proteoform cutoff type provided. Will use default FDR"; return "FDR" }()
...
process TopPIC{
    ...
    script:
    """
    cp ${fasta_file} ${fasta_file.baseName}.fasta
    toppic -d -v ${params.prsm_fdr} -t ${params.prsm_typ} -V ${params.prot_fdr} -T ${params.prot_typ} -u 2 -g -i ${params.mods} ${fasta_file.baseName}.fasta $msalign_file
    """
